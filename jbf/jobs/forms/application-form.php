...
if(!$my_posts || is_super_admin()) {
    if(!empty($_POST)) {
        ...
        $required_fields = array(
            'app-firstname'     => __('Firstname is required.' , 'jbf'),
            'app-lastname'      => __('Lastname is required.', 'jbf'),
            'app-email'         => __('Email is required.', 'jbf'),
            'app-content'       => __('Content is required.', 'jbf')
        );
        ...
        foreach($required_fields as $key => $field) {
            ...
            if($key == 'app-email') {
               if(!is_email($_POST[$key])) {
                    $errors[] = __('Email is invalid', 'jbf');   
        ...
        if(empty($errors)) {
            ...
            include(get_template_directory . '/inc/mail/apply-notification.php');

            //Success message
            $success = __('Your application has been successfully saved', 'jbf');
